        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {teamMembers.map((member) => (
            ...
            >
              {/* Avatar */}
              <div
                className="w-24 h-24 md:w-28 md:h-28 rounded-full flex items-center justify-center text-[#FFC832] text-2xl md:text-3xl font-black shrink-0 group-hover:scale-105 transition-transform duration-300"
