...
export default function LandingCTASection() {
  return (
    <section className="w-full max-w-[1318px] mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
      <div className="relative w-full bg-gradient-to-r from-[#4E0B11] to-[#2D0F12] rounded-[32px] overflow-hidden flex flex-col md:flex-row min-h-[400px] lg:min-h-[456px] shadow-[0_12px_24px_-8px_rgba(0,0,0,0.3)]">
        {/* Decorative Assets */}
        <Image
        ...
        <div className="relative z-10 w-full md:w-[65%] lg:w-[60%] p-12 md:py-16 md:pl-24 lg:py-[72px] lg:pl-[120px] flex flex-col justify-center items-start gap-4">
          ...
          <p className="text-white/95 text-sm md:text-base lg:text-lg max-w-[480px] font-medium leading-relaxed mt-2">
            Temukan Cerita, Filosofi, Dan Warisan Yang Hidup <br className="hidden md:block" /> Dalam Setiap Pendhapa.
          </p>
          <Link
            href="/kuliner"
            className="mt-6 bg-[#ffc832] text-[#3e0b10] font-bold px-8 lg:px-10 py-3.5 lg:py-4 rounded-full flex items-center justify-between gap-8 hover:bg-[#e6b42d] transition-all text-base lg:text-lg shadow-lg w-fit"
          >
